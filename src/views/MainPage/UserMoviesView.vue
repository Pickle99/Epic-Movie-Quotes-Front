  ...
  computed: {
    ...
    filteredUserMovies(){
      return this.userMovies.filter((movie) => {
        ...
        {
          return movie.title.en.toLowerCase().match(this.userMoviesSearch.toLowerCase())
        } else return movie.title.ka.toLowerCase().match(this.userMoviesSearch.toLowerCase())
      });
    },
  },
  methods: {
